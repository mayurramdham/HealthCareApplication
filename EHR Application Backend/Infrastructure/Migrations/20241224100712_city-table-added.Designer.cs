...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241224100712_city-table-added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entity.Appointments.SoapNoteTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SoapNoteTable");
                });

            modelBuilder.Entity("Domain.Entity.AuthProcess.City", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.Appointments.SoapNoteTable", b =>
                {
                    b.HasOne("Domain.Entity.Appointments.Appointment", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entity.AuthProcess.City", b =>
                {
                    b.HasOne("Domain.Entity.Register.State", "State")
                        .WithMany()
